...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n - 1; i++) {
            pq.offer(new Node(x1.get(i).index, x1.get(i + 1).index, Math.abs(x1.get(i).g - x1.get(i + 1).g)));
            pq.offer(new Node(y1.get(i).index, y1.get(i + 1).index, Math.abs(y1.get(i).g - y1.get(i + 1).g)));
            pq.offer(new Node(z1.get(i).index, z1.get(i + 1).index, Math.abs(z1.get(i).g - z1.get(i + 1).g)));
        }
